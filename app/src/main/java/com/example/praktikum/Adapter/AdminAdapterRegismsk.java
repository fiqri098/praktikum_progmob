...
import com.example.praktikum.Admin.AdminDetailRegsmskActivity;
...
public class AdminAdapterRegismsk extends RecyclerView.Adapter<AdminAdapterRegismsk.ViewHolder> {
    ...
    public AdminAdapterRegismsk(ArrayList<Pendaftaran>pendaftaranList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.constraintLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent =  new Intent(context, AdminDetailRegsmskActivity.class);
